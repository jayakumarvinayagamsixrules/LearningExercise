...
using AdventureWorks.Domain.AdventureWorksModels;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace AdventureWorks.Infrastructure.AdventureWorksDbContext;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblSample>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .ValueGeneratedNever()
                .HasColumnName("ID");
            entity.Property(e => e.BitColumn).HasColumnName("BIT_COLUMN");
        });
